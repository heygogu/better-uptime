  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-2">
      ...
      <div className="self-stretch px-6 md:px-16 py-9 relative flex justify-center items-center gap-4">
        {/* Horizontal line */}
        <div className="w-full max-w-265 h-0 absolute left-1/2 transform -translate-x-1/2 top-15.75 border-t border-[rgba(55,50,47,0.12)] z-0"></div>

        {/* Toggle Container */}
        <div className="p-3 relative bg-[rgba(55,50,47,0.03)] border border-[rgba(55,50,47,0.02)] backdrop-blur-[44px] backdrop-saturate-150 backdrop-brightness-110 flex justify-center items-center rounded-full z-20 before:absolute before:inset-0 before:bg-white before:opacity-60 before:rounded-lg before:-z-10">
          <div className="p-0.5 bg-[rgba(55,50,47,0.10)] shadow-[0px_1px_0px_white] rounded-[99px] border-[0.5px] border-[rgba(55,50,47,0.08)] flex justify-center items-center gap-0.5 relative">
            <div
              className={`absolute top-0.5 w-[calc(50%-1px)] h-[calc(100%-4px)] bg-white shadow-[0px_2px_4px_rgba(0,0,0,0.08)] rounded-[99px] transition-all duration-300 ease-in-out ${
          ...
          {/* Decorative dots */}
          <div className="w-0.75 h-0.75 absolute left-1.25 top-[5.25px] bg-primary shadow-[0px_0px_0.5px_rgba(0,0,0,0.12)] rounded-[99px]"></div>
          <div className="w-0.75 h-0.75 absolute right-1.25 top-[5.25px] bg-primary shadow-[0px_0px_0.5px_rgba(0,0,0,0.12)] rounded-[99px]"></div>
          <div className="w-0.75 h-0.75 absolute left-1.25 bottom-[5.25px] bg-primary shadow-[0px_0px_0.5px_rgba(0,0,0,0.12)] rounded-[99px]"></div>
          <div className="w-0.75 h-0.75 absolute right-1.25 bottom-[5.25px] bg-primary shadow-[0px_0px_0.5px_rgba(0,0,0,0.12)] rounded-[99px]"></div>
        </div>
      </div>
